...
export const User = ({ id, avatar, first_name, last_name, email, onClickInviteUser, isInvited }) => (
  <li>
    <div>
    ...
    <img className="action" onClick={() => onClickInviteUser(id)} src={`/assets/${isInvited ? 'minus' : 'plus'}.svg`} alt="Action" />
  </li>
);